...
\begin{document}
	...
	\begin{Tunnell}
		\text{\cite{oort_p3}} (Tunnell, 1983) If $n$ is a squarefree and odd (respectively, even) positive integer ans $n$ is the area of a right triangle with rational sides, then
		\begin{align}
