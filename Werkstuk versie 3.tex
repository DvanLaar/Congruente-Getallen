...
\begin{document}
	...
	We zullen hieronder bewijzen dat $n=1$ geen congruent getal is. Daarvoor bekijken we eerst een stelling die we veel nodig zullen hebben in het bewijs.
	...
	We zullen nu bewijzen dat onderstaande stelling waar is.
	\begin{theorem}
	...
	\begin{proof}
		...
		\end{equation}
		voor oneven positieve gehele getallen $t$ en $u$ die relatief priem zijn.
	\end{proof}
